...
const FAQ = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Qu'est-ce que le quota de SMS inclus et que se passe-t-il s'il est dépassé ?", r: "Le plan Performance inclut 100 SMS de rappel par mois, affichés en temps réel dans l'onglet Rappels. Au-delà, l'envoi continue normalement : chaque SMS supplémentaire (0,10 €) est ajouté automatiquement à votre prochaine facture, sans aucune action de votre part." },
...
const GUIDE_TITULAIRE = [
  ...
  { titre: "Rappels de renouvellement par SMS", badge: "plan Performance", texte: "Depuis l'onglet Rappels, créez un rappel pour un patient (nom, téléphone et date de renouvellement de son ordonnance) : le SMS avec le lien pour indiquer s'il souhaite renouveler part automatiquement environ 7 jours avant cette date — pas besoin de le déclencher vous-même. 100 SMS sont inclus chaque mois (consommation affichée en temps réel dans cet onglet) ; au-delà, chaque SMS supplémentaire (0,10 €) est ajouté automatiquement à votre prochaine facture, sans rien à acheter vous-même." },
...
const GUIDE_VENDEUR = [
  ...
  { titre: "Créer un rappel de renouvellement", badge: "si disponible sur votre pharmacie", texte: "Depuis l'onglet Ordonnances (bouton \"+ Nouveau rappel\", en haut à droite) ou directement depuis une ordonnance (bouton \"Créer son rappel\"), renseignez le nom, le téléphone du patient et sa date de renouvellement. Le SMS avec le lien pour choisir de renouveler ou non part automatiquement environ 7 jours avant cette date." },
